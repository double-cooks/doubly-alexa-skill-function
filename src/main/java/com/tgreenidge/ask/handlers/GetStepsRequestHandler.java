...
public class GetStepsRequestHandler implements RequestHandler {
    private static Logger logger = getLogger(GetRecipeRequestHandler.class);

    @Override
    public boolean canHandle(HandlerInput handlerInput) {
        return handlerInput.matches(intentName("GetStepsIntent"));
    }
    ...
    public Optional<Response> handle(HandlerInput handlerInput) {
        ...
        String steps = ApiHelper.getSteps(title);
